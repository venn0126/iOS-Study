...
#define RESID_CHECKCOPY     @"ID_CHECKCOPY"     //是否复印件   0：彩色  1：灰色
#define RESID_TYPE          @"ID_TYPE"          //正面、反面
#define RESID_COVER         @"ID_COVER"         //遮挡判断：遮挡、未遮挡
...
//银行卡
#define RESBANK_IDIMAGE      @"BANK_IDIMAGE"   //银行卡图片
...
//是否为复印件
//0：彩色   1：灰色
@property (nonatomic, assign) NSInteger checkCopy;
