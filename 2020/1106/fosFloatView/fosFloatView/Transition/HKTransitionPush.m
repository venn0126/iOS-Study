...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext {
    ...
    CGRect floatBallRect = [FOSFloatManger shared].floatBall.frame;
    ...
    UIBezierPath *maskFinalBP = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(0, 0, FOS_SCREEN_WIDTH, FOS_SCREEN_HEIGHT) cornerRadius:floatBallRect.size.width / 2];
    ...
    [UIView animateWithDuration:kAuration animations:^{
        [FOSFloatManger shared].floatBall.alpha = 0;
    }];
}
