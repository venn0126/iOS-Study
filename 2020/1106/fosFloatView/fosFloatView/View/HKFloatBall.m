...
- (void)endTouch:(CGPoint)point {
    ...
    if (point.x > FOS_SCREEN_WIDTH / 2) {
        frame.origin.x = FOS_SCREEN_WIDTH - frame.size.width - margin;
    } else {
        frame.origin.x = margin;
    }
    if (frame.origin.y > FOS_SCREEN_HEIGHT - 64) {
        frame.origin.y = FOS_SCREEN_HEIGHT - 64;
