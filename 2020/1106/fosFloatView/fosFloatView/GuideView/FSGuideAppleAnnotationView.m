...
@interface FSGuideAppleAnnotationView ()
...
@implementation FSGuideAppleAnnotationView

//MARK: - Life cycle
- (instancetype)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        self.backgroundColor = UIColor.fsThemeColor;
...
//MARK: - Getter & Setter
- (void)setModel:(id<FSGuideAnnotationViewModelProtocol>)model {
    _model = model;
...
- (UIButton *)nextButton_protocol {
    if (!_nextButton_protocol) {
        ...
        [button setTitleColor:UIColor.whiteColor.fsDisabledColor forState:UIControlStateDisabled];
...
- (UIButton *)previousButton_protocol {
    if (!_previousButton_protocol) {
        ...
        [button setTitleColor:UIColor.systemGreenColor.fsDisabledColor forState:UIControlStateDisabled];
        [button.titleLabel setFont:self.textLabel_protocol.font];
    }
