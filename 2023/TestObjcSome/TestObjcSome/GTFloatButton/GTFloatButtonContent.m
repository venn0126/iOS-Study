...
@interface GTFloatButtonContent ()
...
@implementation GTFloatButtonContent
...
//    NSBundle *bundle = [NSBundle bundleForClass:[GTFloatButton class]];
//    NSURL *url = [bundle URLForResource:@"GTFloatButton" withExtension:@"bundle"];
