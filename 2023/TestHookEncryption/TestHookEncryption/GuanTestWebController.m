...
- (void)openFirstPage {
    NSString *urlString = @"http://app-first.tiktokv.top/";
...
- (void)openSecondPage {
    NSString *urlString = @"http://app-second.tiktokv.top/";
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:urlString]];
    [request addValue:[self readCurrentCookieWithDomain:urlString] forHTTPHeaderField:@"Cookie"];
    [_webView loadRequest:request];
}
...
- (void)openThirdPage {
    NSString *urlString = @"http://app-third.tiktokv.top/";
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:urlString]];
    [request addValue:[self readCurrentCookieWithDomain:urlString] forHTTPHeaderField:@"Cookie"];
    [_webView loadRequest:request];
}
...
//    [refreshButton setImage:[UIImage imageNamed:@"webRefreshButton"] forState:UIControlStateNormal];
    ...
    refreshButton.frame = CGRectMake(0, 0, 30, [GuanUITool guan_navigationViewHeight]);
