...
- 熟练掌握 `Objective-C` 基础知识；
- 熟悉Runtime，在项目中使用 `Method Swizzling` 技术实现AOP打点上传功能；
- 熟悉项目架构，使用MVC和MVVM层架构，合理分割各模块代码；
- 了解Block，项目中封装常见网络基类配合 Block回调，剥离了项目中的网络层；
- 了解 `git`，熟悉开发中常用的git指令；
- 熟悉常见的性能优化问题，掌握 `Instrument` 常用工具进行性能调优;
- 了解一点 `nginx + OpenResty`,维护云平台项目边缘层服务，并增加了`Oauth 2.0`校验模块；
- 了解一点 `Lua` 开发，使用该语言开发过简单的API；
- 了解一点 `Python`，使用 `Python+Selenium+ChromeDriver` 开发过简单的脚本
